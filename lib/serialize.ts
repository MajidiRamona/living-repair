...
export function serializePublicInitiative(i: Initiative) {
  ...
  return {
    ...
    why_care_about_repair: show('whyCareAboutRepair', i.whyCareAboutRepair ?? undefined),
    knowledge_transmission: show('knowledgeTransmission', i.knowledgeTransmission ?? undefined),
