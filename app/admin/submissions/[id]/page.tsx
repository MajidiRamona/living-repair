      ...
      <div className="container">
        ...
        <SubmissionDetail
          submission={{
            ...
            challengesAndThreatsPublic: submission.challengesAndThreatsPublic,
            needs: (submission.needs as string[] | null) ?? [],
            needsOtherText: submission.needsOtherText,
            needsPublic: submission.needsPublic,
            ...
            whyCareAboutRepair: submission.whyCareAboutRepair,
            knowledgeTransmission: submission.knowledgeTransmission,
